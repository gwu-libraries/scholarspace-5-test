...
module Hyrax
  class CatalogController < ApplicationController
    ...
    configure_blacklight do |config|
      ...
      config.add_results_document_tool(
        :bookmark,
      ...
      config.add_facet_field 'member_of_collection_ids_ssim',
                             limit: 5,
                             label: 'Collections',
                             helper_method: :collection_title_by_id
      ...
      config.add_index_field 'publisher_tesim',
                             itemprop: 'publisher',
                             link_to_facet: 'publisher_sim'
      config.add_index_field 'based_near_label_tesim',
                             itemprop: 'contentLocation',
                             link_to_facet: 'based_near_label_sim'
      config.add_index_field 'language_tesim',
                             itemprop: 'inLanguage',
                             link_to_facet: 'language_sim'
      config.add_index_field 'date_uploaded_dtsi',
      ...
      config.add_index_field 'resource_type_tesim',
                             label: 'Resource Type',
                             link_to_facet: 'resource_type_sim'
      config.add_index_field 'file_format_tesim',
                             link_to_facet: 'file_format_sim'
      config.add_index_field 'identifier_tesim',
                             helper_method: :index_field_link,
                             field_name: 'identifier'
      config.add_index_field Hydra.config.permissions.embargo.release_date,
                             label: 'Embargo release date',
                             helper_method: :human_readable_date
      config.add_index_field Hydra.config.permissions.lease.expiration_date,
