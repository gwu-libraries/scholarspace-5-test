  ...
  module WorkLevel
    module PdfGeneration
      ...
      def joined_pdf_filename
        DerivativeFilenameConstants::JOINED_IMAGES_PDF_FILENAME
      end
      ...
      def attach_pdf_to_work(pdf_path, source_file_set:)
        ...
        attach_single_file_to_work(file_path: pdf_path, user: depositor, service_file: true, source_file_set: source_file_set)
      end
