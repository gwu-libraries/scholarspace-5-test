class CreateSipity < ActiveRecord::Migration[5.2]
  def change
    ...
    add_index "sipity_notification_recipients",
              %w[notification_id role_id recipient_strategy],
    ...
    add_index "sipity_notification_recipients",
              ["role_id"],
              name: "sipity_notification_recipients_role"
    ...
    add_index "sipity_notifications",
              ["name"],
              name: "index_sipity_notifications_on_name",
              unique: true
    add_index "sipity_notifications",
              ["notification_type"],
    ...
    add_index "sipity_notifiable_contexts",
              %w[scope_for_notification_id scope_for_notification_type],
    ...
    add_index "sipity_agents",
              %w[proxy_for_id proxy_for_type],
    ...
    add_index "sipity_comments",
              ["agent_id"],
              name: "index_sipity_comments_on_agent_id"
    add_index "sipity_comments",
              ["created_at"],
              name: "index_sipity_comments_on_created_at"
    add_index "sipity_comments",
              ["entity_id"],
              name: "index_sipity_comments_on_entity_id"
    ...
    add_index "sipity_entity_specific_responsibilities",
              ["agent_id"],
    ...
    add_index "sipity_entity_specific_responsibilities",
              %w[workflow_role_id entity_id agent_id],
    ...
    add_index "sipity_workflows",
              ["name"],
              name: "index_sipity_workflows_on_name",
              unique: true
    ...
    add_index "sipity_workflow_actions",
              ["resulting_workflow_state_id"],
    ...
    add_index "sipity_workflow_actions",
              ["workflow_id"],
              name: "sipity_workflow_actions_workflow"
    ...
    add_index "sipity_workflow_responsibilities",
              %w[agent_id workflow_role_id],
    ...
    add_index "sipity_workflow_roles",
              %w[workflow_id role_id],
    ...
    add_index "sipity_workflow_state_action_permissions",
              %w[workflow_role_id workflow_state_action_id],
    ...
    add_index "sipity_workflow_state_actions",
              %w[originating_workflow_state_id workflow_action_id],
    ...
    add_index "sipity_workflow_states",
              ["name"],
              name: "index_sipity_workflow_states_on_name"
    add_index "sipity_workflow_states",
              %w[workflow_id name],
    ...
    add_index "sipity_roles",
              ["name"],
              name: "index_sipity_roles_on_name",
              unique: true
  end
end
