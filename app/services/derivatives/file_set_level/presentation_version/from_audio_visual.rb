      ...
      class FromAudioVisual
        ...
        def generate_to_cache(source_file_set_id:)
          ...
          Dir.mktmpdir("presentation_av_#{@work.id}_") do |dir|
            ...
            build_presentation(source_path: source_path, output_path: output_path, source_file_set: source_file_set)
        ...
        def source_file_set_for(source_file_set_id)
          ...
          return nil unless file_set && !file_set.service_file && source_audio_visual_file_set?(file_set)
        ...
        def output_extension(source_file_set)
          return '.mp4' if source_video_file_set?(source_file_set)
        ...
        def build_presentation(source_path:, output_path:, source_file_set:)
          ...
          raise "Unable to create audio visual presentation version: #{stderr.to_s.strip.truncate(300)}"
        end
