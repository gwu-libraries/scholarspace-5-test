...
ActiveRecord::Schema[7.2].define(version: 20_230_803_165_135) do
  ...
  create_table 'permission_template_accesses', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[permission_template_id agent_id agent_type access], name: 'uk_permission_template_accesses',
                                                                   unique: true
  ...
  create_table 'sipity_entity_specific_responsibilities', force: :cascade do |t|
    ...
    t.index %w[workflow_role_id entity_id agent_id], name: 'sipity_entity_specific_responsibilities_aggregate',
                                                     unique: true
  ...
  create_table 'sipity_notifiable_contexts', force: :cascade do |t|
    ...
    t.index %w[scope_for_notification_id scope_for_notification_type reason_for_notification notification_id],
            name: 'sipity_notifiable_contexts_concern_surrogate', unique: true
    t.index %w[scope_for_notification_id scope_for_notification_type reason_for_notification],
  ...
  create_table 'sipity_workflow_state_actions', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[originating_workflow_state_id workflow_action_id], name: 'sipity_workflow_state_actions_aggregate',
                                                                  unique: true
  end
  ...
  create_table 'sipity_workflows', force: :cascade do |t|
    ...
    t.index %w[permission_template_id name], name: 'index_sipity_workflows_on_permission_template_and_name',
                                             unique: true
  end
