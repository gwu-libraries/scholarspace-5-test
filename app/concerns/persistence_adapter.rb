...
# maybe this should be handled by the valkyrie adapter, but it currently doesn't seem to be done automatically
module PersistenceAdapter
  ...
  # @return [Valkyrie::Resource] the saved resource
  ...
  # @param resources [Array<Valkyrie::Resource>] the resources to index
