...
class CreateSipity < ActiveRecord::Migration[5.2]
  def change
    ...
    add_index 'sipity_notification_recipients', %w[notification_id role_id recipient_strategy],
    ...
    add_index 'sipity_notification_recipients', ['recipient_strategy'],
    ...
    add_index 'sipity_notifiable_contexts', %w[scope_for_notification_id scope_for_notification_type reason_for_notification notification_id],
              name: 'sipity_notifiable_contexts_concern_surrogate', unique: true
    add_index 'sipity_notifiable_contexts',
              %w[scope_for_notification_id scope_for_notification_type reason_for_notification], name: 'sipity_notifiable_contexts_concern_context'
    add_index 'sipity_notifiable_contexts', %w[scope_for_notification_id scope_for_notification_type],
    ...
    add_index 'sipity_entity_specific_responsibilities', ['agent_id'],
              name: 'sipity_entity_specific_responsibilities_agent'
    add_index 'sipity_entity_specific_responsibilities', ['entity_id'],
              name: 'sipity_entity_specific_responsibilities_entity'
    add_index 'sipity_entity_specific_responsibilities', %w[workflow_role_id entity_id agent_id],
              name: 'sipity_entity_specific_responsibilities_aggregate', unique: true
    add_index 'sipity_entity_specific_responsibilities', ['workflow_role_id'],
    ...
    add_index 'sipity_workflow_actions', ['resulting_workflow_state_id'],
              name: 'sipity_workflow_actions_resulting_workflow_state'
    add_index 'sipity_workflow_actions', %w[workflow_id name], name: 'sipity_workflow_actions_aggregate',
                                                               unique: true
    ...
    add_index 'sipity_workflow_responsibilities', %w[agent_id workflow_role_id],
              name: 'sipity_workflow_responsibilities_aggregate', unique: true
    ...
    add_index 'sipity_workflow_state_action_permissions', %w[workflow_role_id workflow_state_action_id],
              name: 'sipity_workflow_state_action_permissions_aggregate', unique: true
    ...
    add_index 'sipity_workflow_state_actions', %w[originating_workflow_state_id workflow_action_id],
              name: 'sipity_workflow_state_actions_aggregate', unique: true
