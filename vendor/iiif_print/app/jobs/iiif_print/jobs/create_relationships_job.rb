  ...
  module Jobs
    ...
    class CreateRelationshipsJob < IiifPrint::Jobs::ApplicationJob
      ...
      def completed_child_data
        ...
        @pending_children =
          IiifPrint::PendingRelationship.where(parent_id: @parent_id).order(
            "child_order asc"
          )
      ...
      def add_to_work(child_record:, parent_record:)
        @parent_record_members_added =
          IiifPrint.create_relationship_between(
