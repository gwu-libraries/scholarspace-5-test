...
FactoryBot.define do
  factory :archival_document, class: 'ArchivalDocument' do
    ...
    factory :public_archival_document, traits: [:public]
    ...
    factory :invalid_archival_document do
      title { nil }
    end

    factory :private_archival_document do
      # private is default
    ...
    factory :archival_document_with_files do
      before(:create) do |work, evaluator|
        2.times do
    ...
    factory :archival_document_with_image_files do
      before(:create) do |work, evaluator|
        2.times do
          work.ordered_members << create(
            :file_set,
    ...
    factory :archival_document_with_ordered_files do
      before(:create) do |work, evaluator|
        work.ordered_members << create(:file_set, user: evaluator.user)
    ...
    factory :archival_document_with_one_child do
      before(:create) do |work, evaluator|
        work.ordered_members << create(
          :work,
          user: evaluator.user,
    ...
    factory :archival_document_with_two_children do
      before(:create) do |work, evaluator|
        work.ordered_members << create(
          :work,
          user: evaluator.user,
    ...
    factory :archival_document_with_representative_file do
      before(:create) do |work, evaluator|
        work.ordered_members << create(
          :file_set,
          user: evaluator.user,
    ...
    factory :archival_document_with_file_and_work do
      before(:create) do |work, evaluator|
        work.ordered_members << create(:file_set, user: evaluator.user)
        work.ordered_members << create(:archival_document, user: evaluator.user)
      end
    end

    factory :archival_document_with_embargo_date do
      # build with defaults:
      ...
      factory :embargoed_archival_document do
        after(:build) do |work, evaluator|
      ...
      factory :embargoed_archival_document_with_files do
        after(:build) do |work, evaluator|
          if evaluator.with_embargo_attributes
            work.apply_embargo(
              evaluator.with_embargo_attributes[:embargo_date],
    ...
    factory :archival_document_with_lease_date do
      # build with defaults:
      ...
      factory :leased_archival_document do
        after(:build) do |work, evaluator|
      ...
      factory :leased_archival_document_with_files do
        after(:build) do |work, evaluator|
          if evaluator.with_lease_attributes
            work.apply_lease(
              evaluator.with_lease_attributes[:lease_date],
