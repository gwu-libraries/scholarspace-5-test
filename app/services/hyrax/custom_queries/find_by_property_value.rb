...
# Pending merge to main brance of hyrax from this commit: https://github.com/samvera/hyrax/commit/c99d56fa2dbedfc23fff86f76b0a6668cb029463
module Hyrax
    ...
    class FindByPropertyValue
      ...
      def find_ids_by_property_pairs(pairs:, field_types: :symbol, **options)
        ...
        query = pairs.map do |k, v|
          if field_types.is_a? Hash
            type = field_types[k] || :symbol
          else
            type = field_types
          end
